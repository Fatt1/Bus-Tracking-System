...
// --- COMPONENT MODAL THÔNG TIN CÁ NHÂN (ĐÃ CẬP NHẬT) ---
const DriverProfileModal = ({ isOpen, onClose }) => {
  ...
  const fetchDriverProfile = async () => {
    ...
    try {
      ...
      setError(t("driverApp.profile.loadError"));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  // Format date from backend DateOnly (YYYY-MM-DD)
      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="modal-error">
            <p>{error}</p>
            <button onClick={fetchDriverProfile} className="retry-btn">
              {t("common.retry")}
            </button>
          </div>
        ) : driverProfile ? (
          <form onSubmit={handleSubmit} className="profile-form">
            ...
            <div className="profile-left-column">
              <img
                src={`https://i.pravatar.cc/150?u=${driverProfile.userId}`}
                alt="Avatar"
                  ...
                  <div className="form-group">
                    ...
                    <div className="date-input-with-icon">
                      <input
                        type="text"
                        id="birthDate"
                        value={formatDate(driverProfile.dateOfBith)}
                        readOnly
                      />
              ...
              <section className="profile-section">
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    id="phone"
                    value={driverProfile.phoneNumber}
                    readOnly
                  />
                </div>
                <div className="form-group">
            ...
            <>
              <section className="driver-welcome-section">
                <div className="driver-info-card">
                  <img src={`https://i.pravatar.cc/150?u=${fullName}`} alt="Driver Avatar" />
